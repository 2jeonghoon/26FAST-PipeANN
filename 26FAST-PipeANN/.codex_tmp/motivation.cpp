...
#define NUM_ACTIVE_INSERT_THREADS 1
#define NUM_MERGE_THREADS 2
#else
#define NUM_SEARCH_THREADS 32
#define NUM_ACTIVE_INSERT_THREADS 2
...
#pragma omp parallel num_threads(NUM_ACTIVE_INSERT_THREADS)
  {
...
#ifdef DISKANN_ENABLE_CPU_ISOLATION_EXPERIMENT
  // Leave CPUs 7-8 to NVMeVirt workers and pin merge to the remaining CPUs.
  setenv(diskann::thread_affinity::kAffinityAllowedCpusEnv, "0-6,9", 1);
  setenv("DISKANN_MERGE_THREADS", "2", 1);
  diskann::thread_affinity::configure_balanced_role_cpus(
      NUM_SEARCH_THREADS, NUM_ACTIVE_INSERT_THREADS, NUM_MERGE_THREADS,
      "motivation_affinity");
#endif
